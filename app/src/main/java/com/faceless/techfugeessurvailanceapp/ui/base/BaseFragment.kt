...
import com.faceless.techfugeessurvailanceapp.data.network.RemoteDataSource
...
abstract class BaseFragment<VM: ViewModel, B: ViewBinding, R: BaseRepository>: Fragment() {
    ...
    override fun onCreateView(
        ...
        viewModel = ViewModelProvider(this, factory).get(geViewModel())
    ...
    abstract fun geViewModel() : Class<VM>
